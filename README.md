...
A community-driven collection of Lua mods for the game **Wars Selection**, plus an English modding guide documenting the game's unit and building parameters.
...
Ready-to-use mods live in [mods/](mods/) — see its README for the full list and installation instructions.
