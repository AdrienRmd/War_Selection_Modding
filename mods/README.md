...
| [house_production](house_production/) | Configurable periodic income for houses: enable/disable, amount, resource(s) and period, edited in code; negative amounts act as upkeep. | ![WIP](https://img.shields.io/badge/Status-WIP-orange.svg) | — |
