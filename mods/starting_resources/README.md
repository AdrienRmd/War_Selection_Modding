...
> [!NOTE]
> This mod is **already published in the base game** — you can add it to your map directly with the ID above (**Mods** → **Add a modification** in the map editor). This repository keeps the source code for reference and customization.
...
Or use the **Mod ID** at the top of this page to add the mod directly, without copying any code.
